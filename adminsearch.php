      ...
      <div class="container h-100">
        <div class="row h-100">
              ...
              <div class="device-mockup ipad black">
                <div class="device">
                  <div class="screen">
                    ...
                    <a href="adminmusic.php"><img src="img/audreyhepburn.jpg" class="img-fluid" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
		  ...
		  <div class="col-lg-7 my-auto">
			...
			<br></br>
              <a href="adminmusic.php"><h1 class="mb-5">AUDREY HEPBURN -MOON RIVER</h1></a>
			  <h6>Classic Songs</h6> <h6>Phoebe Knight</h6> <h6>15-December-2017</h6>
			  <a href="adminmusic.php" class="btn btn-outline btn-xl js-scroll-trigger">Edit</a>
            </div>
          </div>       
      </div>
	  </div>
      ...
      <div class="container h-100">
        <div class="row h-100">
            ...
            <div class="device-container">
              <div class="device-mockup ipad black">
                <div class="device">
                  <div class="screen">
                    <!-- Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
                    <a href="adminmusic.php"><img src="img/coldplay.jpg" class="img-fluid" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
		  ...
		  <div class="col-lg-7 my-auto">
            <div class="header-content mx-auto">
			<br></br>
              <a href="adminmusic.php"><h1 class="mb-5">COLDPLAY - A SKY FULL OF STARS</h1></a>
      ...
      <div class="container h-100">
        <div class="row h-100">
            ...
            <div class="device-container">
              <div class="device-mockup ipad black">
                <div class="device">
                  <div class="screen">
                    <!-- Demo image for screen mockup, you can put an image here, some HTML, an animation, video, or anything else! -->
                    <a href="adminmusic.php"><img src="img/coldplay2.jpg" class="img-fluid" alt=""></a>
                  </div>
                </div>
              </div>
            </div>
		  ...
		  <div class="col-lg-7 my-auto">
            <div class="header-content mx-auto">
			<br></br>
              <a href="adminmusic.php"><h1 class="mb-5">COLDPLAY - EVERGLOW</h1></a>
