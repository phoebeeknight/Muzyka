      ...
      <div class="container h-100">
		...
		<div class="col-md-5">
			...
			<div class="form-group">			
				...
				<input type="text" class="form-control" id="name" value="Phoebe Knight" >
			</div>
	
			<div class="form-group">
				<label for="id">ID:</label>
				<input type="text" class="form-control" id="id" value="A001" >
			</div>
			
			<div class="form-group">
				<label for="email">Email:</label>
				<input type="email" class="form-control" id="email" value="phoebe@gmail.com" >
			</div>

			<div class="form-group">
				<label for="password">Password:</label>
				<input type="text" class="form-control" id="password" value="abc123" >
			</div>
		...
		<div class="col-md-5">
			...
			<div class="form-group">
				...
				<input type="date" class="form-control" id="dob" value="15/12/1996" >
			</div>
			
			<div class="form-group">
				<label for="ic">IC ]:</label>
				<input type="text" class="form-control" id="ic" value="961215-12-3456" >
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="address" value="Jalan Taman" >
			</div>
		
		</div>		
		</div>
              <a href="profile.php" class="btn btn-outline btn-xl js-scroll-trigger">Save</a>
			  <a href="profile.php" class="btn btn-outline btn-xl js-scroll-trigger">Cancel</a>
          </div>
        </div>
      </div>
    </header>
